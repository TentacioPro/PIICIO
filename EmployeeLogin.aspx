...
<body>
    ...
    <section class="banner-bottom-w3ls pt-lg-5 pt-md-3 pt-3">
        <div class="inner-sec-wthreelayouts pt-md-5 pt-md-3 pt-3" align="center">
			<h2 class="heading-agileinfo text-center  mb-4">Employee <span> Login</span></h2>
                        ...
                        <div class="form" align="center">
                            ...
                            <form action="#" method="post" runat="server" align="center">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="TextBox2" runat="server" style="text-align: center" class="form-control" placeholder="" required="" TextMode="Password" Height="50" Width="400" BorderColor="#003300" Font-Italic="False" ForeColor="#660033" Font-Size="13"></asp:TextBox>
                                </div>
                                <br />
                                <div class="input-group1">
                                    <asp:Button ID="Button1" runat="server" Text="Login" class="form-control" Height="60" Width="300" OnClick="Button1_Click" />
                                </div>
                            </form>
                        </div>
                    </div>
