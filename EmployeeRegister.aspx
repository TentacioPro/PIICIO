...
<body>
    ...
    <section class="banner-bottom-w3ls pt-lg-5 pt-md-3 pt-3">
        <div class="inner-sec-wthreelayouts pt-md-5 pt-md-3 pt-3" align="center">
			<h2 class="heading-agileinfo text-center  mb-4">Employee <span> Register</span></h2>
                            ...
                            <form action="#" method="post" runat="server" align="center">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <asp:TextBox ID="TextBox6" runat="server" class="form-control" style="text-align: center" placeholder="" required="" Height="50" Width="400" BorderColor="#003300" Font-Italic="False" ForeColor="#660033" Font-Size="13"></asp:TextBox>
                                </div>  
                                <br />
