...
public partial class EmployeeSendInformation : System.Web.UI.Page
{
    string TLID = null;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        document.Open();
        var welcomeParagraph = new Paragraph("EmployeeID : : "+TextBox1.Text + "\n" + "\n" + "EmployeeName : : " +TextBox2.Text+ "\n"+ "\n" + "Details : : " + "\n"+TextBox3.Text);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        con4.Open();
        cmd = new SqlCommand("insert into SendInformation values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + fn + "','"+TLID+"','" + date + "')", con4);
        cmd.ExecuteNonQuery();
        con4.Close();
        ...
        var writer = PdfWriter.GetInstance(document, output);
        document.Open();
        var welcomeParagraph = new Paragraph("Employee ID : : " + TextBox1.Text + "\n" + "\n" + "Employee Name : : " + TextBox2.Text + "\n" + "\n" + "Details : : " + "\n" + TextBox3.Text);
        document.Add(welcomeParagraph);
        document.Close();
