<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRManagerNotification.aspx.cs" Inherits="HRManagerNotification" %>
                            ...
                            <form id="form1" runat="server">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Size="13pt" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Italic="False" DataSourceID="SqlDataSource1">
                                 ...
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrganizationConnectionString %>" SelectCommand="SELECT [EmployeeID], [Name], [FileName], [Date] FROM [SendInformation] WHERE ([Who] = @Who) ORDER BY [ID] DESC">
                                     <SelectParameters>
                                         <asp:Parameter DefaultValue="Manager" Name="Who" Type="String" />
                                     </SelectParameters>
                                </asp:SqlDataSource>
                                 </form>
                        </div>
