<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRManagerTLAttendance.aspx.cs" Inherits="HRManagerTLAttendance" %>
                        ...
                        <div class="form" align="center">
                            ...
                            <form id="form1" runat="server">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Size="13pt" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Italic="False" DataSourceID="SqlDataSource1">
                                    <Columns>
                                        <asp:BoundField DataField="TeamLeaderID" HeaderText="TeamLeaderID" SortExpression="TeamLeaderID" />
                                 ...
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrganizationConnectionString %>" SelectCommand="SELECT [TeamLeaderID], [Name], [Date] FROM [TLAttendanceDetails] WHERE ([Date] = @Date) ORDER BY [ID] DESC">
                                     <SelectParameters>
