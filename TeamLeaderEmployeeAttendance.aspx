<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeamLeaderEmployeeAttendance.aspx.cs" Inherits="TeamLeaderEmployeeAttendance" %>
...
<body>
    ...
    <section class="banner-bottom-w3ls pt-lg-5 pt-md-3 pt-3">
        <div class="inner-sec-wthreelayouts pt-md-5 pt-md-3 pt-3" align="center">
			<h2 class="heading-agileinfo text-center  mb-4">Employee <span> Attendance</span></h2>
                    ...
                    <div class="col-md-6 " align="center">
                        <div class="form" align="center">
                            ...
                            <form id="form1" runat="server">
                                ...
                                <asp:TextBox ID="TextBox3" runat="server" style="text-align: center" class="form-control" placeholder="" required="" Height="50" Width="400" BorderColor="#003300" Font-Italic="False" ForeColor="#003300" Font-Size="13pt" Font-Bold="True" ReadOnly="True" Visible="False"></asp:TextBox>
                                <br />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrganizationConnectionString %>" SelectCommand="SELECT [EmployeeID], [Name], [Date] FROM [EAttendanceDetails] WHERE (([TeamLeaderID] = @TeamLeaderID) AND ([Date] = @Date)) ORDER BY [ID] DESC">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="TextBox1" Name="TeamLeaderID" PropertyName="Text" Type="String" />
                                        <asp:ControlParameter ControlID="TextBox3" Name="Date" PropertyName="Text" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
