...
public partial class TeamLeaderEmployeeDetails : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        con3.Open();
        cmd = new SqlCommand("update EmployeeDetails set Status='Accept' where EmployeeID='" + a + "'", con3);
        cmd.ExecuteNonQuery();
        con3.Close();
        Response.Write("<script>alert('Accepted Successfully')</script>");
        Response.Redirect("TeamLeaderEmployeeDetails.aspx");
        Response.Write("<script>alert('Accepted Successfully')</script>");
    }
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        // string date = DateTime.Now.ToString("dd/MM/yyyy");
        con3.Open();
        cmd = new SqlCommand("update EmployeeDetails set Status='Reject' where EmployeeID='" + a + "'", con3);
        cmd.ExecuteNonQuery();
        con3.Close();
