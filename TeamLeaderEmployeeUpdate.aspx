<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeamLeaderEmployeeUpdate.aspx.cs" Inherits="TeamLeaderEmployeeUpdate" %>
...
<body>
    ...
    <section class="banner-bottom-w3ls pt-lg-5 pt-md-3 pt-3">
        <div class="inner-sec-wthreelayouts pt-md-5 pt-md-3 pt-3" align="center">
			<h2 class="heading-agileinfo text-center  mb-4">Employee <span> Update</span></h2>
                        ...
                        <div class="form" align="center">
                            ...
                            <form id="form1" runat="server">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="my-2">Enter Captcha</label>
                                    <asp:TextBox ID="TextBox3" runat="server" style="text-align: center" class="form-control" placeholder="" Height="50" Width="400" BorderColor="#003300" Font-Italic="False" ForeColor="#003300" Font-Size="13pt" Font-Bold="True"></asp:TextBox>
                                </div>
                                ...
                                <div class="input-group1">
                                    <asp:Button ID="Button1" runat="server" Text="Submit" class="form-control" Height="60" Width="300" BackColor="#00CCFF" BorderColor="Black" Font-Bold="True" ForeColor="#660066" Font-Size="15" OnClick="Button1_Click" />
                                </div>
                                <div class="form-group">
                                    <label class="my-2">Employee Update Details</label>
                                    <asp:TextBox ID="TextBox4" runat="server" class="form-control" Height="600" Width="500" BorderColor="#003300" ForeColor="#000066" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                                </div>
                           </form>
                        </div>
                    </div>
