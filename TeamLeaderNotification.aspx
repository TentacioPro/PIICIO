<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeamLeaderNotification.aspx.cs" Inherits="TeamLeaderNotification" %>
...
<body>
    ...
    <section class="banner-bottom-w3ls pt-lg-5 pt-md-3 pt-3">
        <div class="inner-sec-wthreelayouts pt-md-5 pt-md-3 pt-3" align="center">
			<h2 class="heading-agileinfo text-center  mb-4">Any <span> Notification</span></h2>
                    ...
                    <div class="col-md-6 " align="center">
                        <div class="form" align="center">
                            ...
                            <form id="form1" runat="server">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrganizationConnectionString %>" SelectCommand="SELECT [EmployeeID], [Name], [FileName], [Date] FROM [SendInformation] WHERE ([Who] = @Who) ORDER BY [ID] DESC">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="TextBox1" Name="Who" PropertyName="Text" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
