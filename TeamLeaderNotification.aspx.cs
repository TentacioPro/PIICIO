...
public partial class TeamLeaderNotification : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        con2.Open();
        cmd = new SqlCommand("select Password from TeamLeaderDetails where EmployeeID='" + TextBox1.Text + "'", con2);
