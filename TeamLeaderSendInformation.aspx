<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeamLeaderSendInformation.aspx.cs" Inherits="TeamLeaderSendInformation" %>
                    ...
                    <div class="col-md-6 " align="center">
                        <div class="form" align="center">
                            ...
                            <form id="form1" runat="server">
                                ...
                                <div class="input-group1">
                                    <asp:Button ID="Button2" runat="server" Text="Send to Employee" class="form-control" Height="60" Width="300" BackColor="#FFFF99" BorderColor="Black" Font-Bold="True" ForeColor="#660066" Font-Size="15" OnClick="Button2_Click"/>
                                </div>
